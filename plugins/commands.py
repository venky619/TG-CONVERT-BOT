...
my_father = "https://t.me/Wizard09".format(Config.USER_NAME[1:])
support = "https://telegram.dog/Super_botz_support"
...
async def start(c, m):
    ...
    await c.send_message(chat_id=m.chat.id,
                         ...
                         reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("My Father 👨‍💻", url=https://t.me/Wizard09), InlineKeyboardButton("📌Support channel", url=https://t.me/Super_botz)]]))
